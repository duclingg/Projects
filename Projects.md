...
I have implemented brand new features, as well as continuous debugging and bug fixes such as:  
- Features in our brand new camera
- Infinite scrolling/paging bug fixes in the editor
- Features on our custom filter creation tool... TBA
...
When I took data structures and algorithms in my bachelor's program, I always wished for an easier, more visual representation of how these systems work; so, I decided to build a visualizer myself. I want to help others that have a visual learning style, and make computer science and software engineering more accessible.  

***New/Updated UI/UX! (as of Jan 2025)***  
#### Graph Demo
